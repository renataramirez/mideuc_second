  ...
  "errores_detectados": {{
      ...
      "vocabulario": [
        {{
          "error": "error original", 
          "correccion": "corrección propuesta",
          "subcategoria": "amplitud/precision_lexica/registro_formal"
        }}
      ],
      "cohesion": [
        {{
          "error": "error original",
          "correccion": "corrección propuesta",
          "subcategoria": "concordancia/conexion/referencias"
        }}
      ]
  }}
}}
...
- VOCABULARIO → solo amplitud, precision_lexica, registro_formal
- COHESIÓN → solo concordancia_gramatical, conexion_textual y referencias_y_correferencias
